...
public class SettingsGateway {
    ...
    public static final String[] SETTINGS_FOR_RESTRICTED = {
            ...
            Settings.TweaksAboutActivity.class.getName(),
            Settings.TweaksProfileActivity.class.getName(),
            Settings.TweaksClockFacesActivity.class.getName(),
            Settings.TweaksLockscreenActivity.class.getName(),
            Settings.TweaksThemesActivity.class.getName(),
            Settings.TweaksFontsActivity.class.getName(),
            Settings.TweaksBatteryActivity.class.getName(),
            Settings.TweaksStatusBarActivity.class.getName(),
            Settings.TweaksQuickSettingsActivity.class.getName(),
            Settings.TweaksPowerMenuActivity.class.getName(),
            Settings.TweaksVolumeActivity.class.getName(),
            Settings.TweaksSystemActivity.class.getName(),
            Settings.TweaksMiscActivity.class.getName(),
            Settings.TweaksGesturesActivity.class.getName(),
            Settings.TweaksNotificationsActivity.class.getName(),
    };
}
